package club.andnext.com.rd.draw.controller;
...
import club.andnext.com.rd.animation.type.AnimationType;
import club.andnext.com.rd.animation.type.BaseAnimation;
import club.andnext.com.rd.animation.type.ColorAnimation;
import club.andnext.com.rd.animation.type.FillAnimation;
import club.andnext.com.rd.animation.type.ScaleAnimation;
import club.andnext.com.rd.draw.data.Indicator;
import club.andnext.com.rd.draw.data.Orientation;
import club.andnext.com.rd.draw.data.RtlMode;
import club.andnext.com.rd.pageindicatorview.R;
import club.andnext.com.rd.utils.DensityUtils;
...
public class AttributeController {
    ...
    private void initAnimationAttribute(@NonNull TypedArray typedArray) {
        ...
        long animationDuration = (long) typedArray.getInt(R.styleable.PageIndicatorView2_piv_animationDuration, BaseAnimation.DEFAULT_ANIMATION_TIME);
        ...
        boolean fadeOnIdle = typedArray.getBoolean(R.styleable.PageIndicatorView2_piv_fadeOnIdle, false);
        long idleDuration = (long) typedArray.getInt(R.styleable.PageIndicatorView2_piv_idleDuration, DEFAULT_IDLE_DURATION);
