...
import club.andnext.com.rd.animation.type.*;
import club.andnext.com.rd.draw.controller.DrawController;
import club.andnext.com.rd.draw.data.Indicator;
import club.andnext.com.rd.draw.data.Orientation;
import club.andnext.com.rd.draw.data.PositionSavedState;
import club.andnext.com.rd.draw.data.RtlMode;
import club.andnext.com.rd.utils.CoordinatesUtils;
import club.andnext.com.rd.utils.DensityUtils;
import club.andnext.com.rd.utils.IdUtils;
...
public class PageIndicatorView2 extends View implements IndicatorManager.Listener, View.OnTouchListener {
    ...
    /**
     * Fade on idle will make {@link PageIndicatorView2} {@link View#INVISIBLE} if {@link ViewPager2} is not interacted
     ...
     *
     * @param fadeOnIdle boolean value to hide {@link PageIndicatorView2} when {@link ViewPager2} is idle
     */
    ...
    /**
     * Sets time in millis after which {@link ViewPager2} is considered idle.
     ...
     *
     * @param duration time in millis after which {@link ViewPager2} is considered idle
     */
